...
parser.add_argument('--save_epoch', type=int, default=500000, help='saved epoch of the model for test')
parser.add_argument('--model_path', type=str, default="/home/wanghejun/Desktop/wanghejun/WeatherShift/main/result/classifier/0/save", help='path to the trained model')
...
# print(preds)
# for p in labels:
#     if p == WEATHERS.index('light_fog_night'):
#         print(p)
...
# 设置标题和标签
title = 'Confusion Matrix(Accuracy='+str(np.round(accuracy, 3))+''
plt.title('Confusion Matrix (Accuracy={})'.format(accuracy), fontsize=50)
